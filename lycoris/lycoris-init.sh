#!/bin/bash
# Set up a lycoris service to join the lycoris-1 chain.
...
NODE_HOME=~/.lycoris
NODE_MONIKER=lycoris
# ***

CHAIN_BINARY_URL='https://github.com/taramakage/lycoris/releases/download/v0.1.0/lycorisd'
CHAIN_BINARY='lycorisd'
CHAIN_ID=lycoris-1
PERSISTENT_PEERS="0571871b2cdf235a3ba8c1a4b03ac996d29a1f70@35.230.9.134:36656,0571871b2cdf235a3ba8c1a4b03ac996d29a1f70@35.230.9.134:36656"
...
# rm -rf lycoris
# git clone https://github.com/taramakage/lycoris.git
# cd lycoris
...
echo "Description=lycoris service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the lycoris service:"
